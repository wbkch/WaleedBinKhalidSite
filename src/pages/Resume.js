  ...
  >
    <article className="post" id="resume">
      ...
      <div style={{ height: '100vh' }}>
        ...
        <iframe className="holds-the-iframe" title="Waleed Resume" src="https://docs.google.com/gview?url=https://github.com/wbkch/wbkch/raw/mater/Waleed%20Resume.pdf&embedded=true" style={{ width: '100%', height: '100%' }} frameBorder="0" />
      </div>
